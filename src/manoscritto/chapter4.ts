Capitolo 4: La Geometria del Consenso
L'aria all'ottantesimo piano scorreva sterile. Filtri di purificazione soffiavano un alito gelido che a Julian Vane serviva solo a mantenere intatta la lucidità.
Si avvicinò alla vetrata. Sotto i suoi piedi, Ginevra bruciava. Nel settore sud, bagliori d'incendi improvvisati squarciavano la coltre di smog. La nebbia notturna assorbiva quel riflesso, trasformando il panorama in una lenta agonia arancione. Julian fissava quello scempio. Non provava nulla.
Si voltò verso la parete. La proiezione olografica riempiva tre metri di stanza con dati nitidi, privi di sfumature inutili. La mappa del settore sud-4 pulsava. Piccoli punti rossi indicavano il calore dei bidoni in fiamme e dei cortili trasformati in bivacchi. Quattro notti prima l'Amministrazione aveva tagliato il riscaldamento nei blocchi dal B-17 al B-23. Quarantaduemila corpi assideravano al buio. Il sistema contava unità. Gestiva asset. L'angoscia umana restava rumore incalcolabile.
...
Un tono basso confermò l'operazione. Sulla mappa, il settore sud mutava colore. Il rosso della rivolta sbiadiva nel bianco dell'emergenza medica. Il protocollo di risposta sostituiva scudi e lacrimogeni con le uniformi candide di ABITES. Kit nutrizionali. Razioni.
E cerotti neurali.
Alle sue spalle, le porte si spalancavano. Il passo cadenzato del Generale Müller risuonava sulla resina del pavimento prima ancora che l'uomo entrasse nel campo visivo di Julian. Il generale avanzava con un tablet stretto sotto il braccio, le tempie imperlate di sudore, il colletto dell'uniforme aperto per un bisogno d'aria negato dalla stanza.
Julian attese. Volse il corpo solo quando il generale era a metà stanza.
...
Müller serrò le mascelle. «E lascerà bruciare, questa città?»
«Abbiamo attivato le squadre sanitarie.»
«Non basteranno a calmare chi muore di freddo...»
...
Müller aprì la bocca. Le parole restarono intrappolate nei polmoni. Quando comprese, il viso sbiancò.
...
«Quarantaquattro mesi fa l'adesione volontaria ai cerotti era ferma al tre virgola otto percento. Oggi?»
Müller tacque.
...
L'aria nella stanza divenne pesante. Müller riprese fiato con fatica. «Chi rifiuterà il programma anche dopo questo trauma?»
...
Julian lo squadrò. Il mento di Müller puntava ancora verso l'alto, come una barca rimasta in secca dopo la mareggiata.
«Vada, generale.»
...
Sullo schermo, i punti caldi nel blocco B-19 bruciavano come previsto. Tra trentasei ore le squadre mediche avrebbero varcato la soglia. Tra quarantotto, la fame e il ghiaccio avrebbero compiuto l'opera. Tra due settimane, la rete neurale avrebbe assorbito un altro picco di adesioni. Il sistema si chiudeva. Un punto percentuale alla volta.
Julian posò il bicchiere. Osservò la pioggia invisibile battere contro il vetro, muta. Tornò a guardare il panorama.
Ginevra bruciava. Julian osservò quella luce con fredda soddisfazione. Sapeva che tra dieci anni quella città non avrebbe più bruciato.
Non perché qualcuno avrebbe salvato la città.
