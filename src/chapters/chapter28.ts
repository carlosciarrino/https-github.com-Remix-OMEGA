...
Claudio lo capì un secondo dopo essere uscito dall'ascensore, quando i propri passi tornarono indietro moltiplicati — non un'eco normale, ma un'eco laterale, riflessa da superfici verticali su entrambi i lati del corridoio che restituivano l'immagine di lui e Laura in angolazioni leggermente diverse da quelle attese. Il vetro era antiproiettile — cinque centimetri di spessore, con una tinta che nelle superfici affiancate produceva riflessi a catena, ogni lastra che rimandava l'immagine alla successiva in una regressione che si perdeva nell'oscurità oltre la curva del corridoio.
...
Laura si avvicinò alla parete di vetro sulla sinistra e vi posò una mano, la pressione che appannava il vetro in un cerchio piccolo intorno alle dita. Guardò oltre — dall'altra parte c'era un altro corridoio parallelo, vuoto, illuminato dalla stessa luce bianca fredda. Poi guardò Claudio.
Lui aprì il lettore modificato e cercò la mappa dell'edificio nel database che aveva caricato prima di partire — i vecchi schemi, l'architettura originale. La sovrappose mentalmente a quello che stava vedendo. Tre metri a sinistra dove non doveva esserci nulla. Due pareti di vetro dove i suoi schemi mostravano una sola paratia metallica. Un incrocio a T venti metri avanti dove i suoi piani prevedevano un corridoio diritto fino all'accesso al nucleo.
...
Claudio si fermò al centro dell'incrocio. Guardò a sinistra — un corridoio che curvava dopo dieci metri verso qualcosa che non riusciva a vedere. Guardò a destra — un corridoio diritto con una porta metallica in fondo, chiusa. Guardò dritto — il corridoio continuava verso quello che i suoi calcoli indicavano come la direzione del nucleo.
Laura stava guardando il soffitto.
Il sistema reagì prima che lei potesse dirgli cosa aveva visto.
Il suono fu il primo segnale — un sibilo pneumatico che partì contemporaneamente da tre punti diversi nel soffitto dell'incrocio, e Claudio alzò gli occhi e vide le scanalature che si aprivano nel soffitto bianco, tre linee parallele che correvano da parete a parete in direzioni diverse. Dal corridoio a sinistra arrivò lo stesso suono, poi dal corridoio dritto.
«Corri,» disse Laura, e stava già correndo verso il corridoio dritto.
Claudio la seguì. La prima paratia di vetro scese alle sue spalle — la sentì abbassarsi nell'aria, la corrente d'aria fredda che si muoveva verso il basso, poi il colpo sordo sul pavimento in resina che fece vibrare le suole degli stivali. La seconda scese davanti all'incrocio a sinistra, chiudendo quella direzione. La terza stava scendendo dal corridoio dritto, a sei metri davanti a loro.
Claudio calcolò la distanza e la velocità di discesa della paratia con la parte di cervello che non aveva ancora esaurito le riserve e accelerò, spingendo sulle gambe con tutto quello che aveva rimasto, il polso che protestava con ogni oscillazione delle braccia. Tre metri. Due. La paratia era a un metro e mezzo dal pavimento.
Laura passò sotto con la testa bassa e le spalle piegate in avanti, il bordo inferiore della paratia che le sfiorò lo zaino con un suono di plastica contro vetro.
La paratia continuò a scendere.
Claudio era a mezzo metro. Vide il bordo inferiore a un metro dal pavimento, poi a ottanta centimetri, e si gettò in avanti con le braccia davanti alla testa e sentì il vetro freddo contro la schiena — un contatto brevissimo, un millimetro di distanza — e poi era dall'altra parte sul pavimento in resina con le ginocchia che assorbivano l'impatto e le mani che fermavano il resto.
...
Claudio lo capì nel momento in cui ci sbatté contro con la spalla destra — non cedette di un millimetro, non vibrò, non produsse il suono cavo di qualcosa di fragile. Produsse il suono pieno e definitivo di qualcosa che non era stato progettato per cedere a nessun impatto che un corpo umano potesse generare.
Laura era dall'altra parte.
Erano a trenta centimetri l'uno dall'altra — la paratia in mezzo, trasparente, che permetteva di vedere ogni dettaglio ma non di toccarsi. Claudio vedeva la striscia di sangue sul dorso della sua mano sinistra, il modo in cui le spalle si erano alzate di qualche centimetro nel momento in cui la paratia era scesa. Vedeva il respiro — il vapore che si formava davanti alla sua bocca nell'aria fredda del corridoio e si disperdeva verso il basso, lento.
Laura appoggiò il palmo sinistro sul vetro.
Claudio cercò il bordo della paratia — a destra, dove incontrava la parete laterale del corridoio. Il giunto era a tenuta stagna, sigillato con una guarnizione di polimero che non lasciava spazio per nessuno strumento. A sinistra, lo stesso. In basso, il bordo era incassato in una scanalatura nel pavimento. In alto, spariva nel soffitto.
Trovò un pannello di controllo sulla parete destra — un display numerico con una tastiera a dodici tasti, lo stesso sistema che aveva progettato per i pannelli di emergenza del livello. Digitò il codice di sblocco manuale che conosceva a memoria — sei cifre, il codice originale di progettazione che non avrebbe dovuto funzionare da quando era uscito dal sistema e che non funzionò neanche questa volta, il display che lampeggiò rosso una volta e tornò allo stato di attesa.
Provò con il codice Sigma-sette. Rosso.
Pose il polso destro sul pannello e sentì il lettore biometrico integrato nel bordo del display tentare l'identificazione — un formicolio leggero attraverso la fasciatura, poi il rosso di nuovo, poi la scritta: ACCESSO REVOCATO.
Laura aveva già tolto la mano dal vetro. Stava guardando intorno a sé — le pareti, il soffitto, il pannello sul suo lato della paratia. Fece un gesto — indicò il proprio pannello, poi aprì le mani in una domanda.
Claudio scosse la testa. Stessi codici, stessa risposta.
Tornò al vetro. Le sue dita si posarono sulla superficie fredda — la destra prima, poi la sinistra sopra, e il polso ustionato protestò nel momento in cui il freddo del vetro raggiunse le terminazioni nervose sotto la fasciatura. Rimase fermo così, le palme piatte sul vetro, e dall'altra parte Laura fece la stessa cosa — le sue mani sulle sue, separate da cinque centimetri di materiale che non aveva parole per essere descritto altrimenti che come un tipo di distanza che la fisica non avrebbe dovuto permettere.
...
Era diversa dall'Agente Logistico. Più bassa di due toni, con una qualità delle consonanti che il precedente non aveva — articolata con una precisione che risultava studiata, non casuale.
...
Claudio non abbassò le sue. Rimase con i palmi sulla superficie fredda e guardò Laura attraverso il vetro mentre lei si girava verso gli altoparlanti con la schiena a lui — le spalle strette verso l'interno, la testa leggermente abbassata. Non riusciva a vedere il suo viso.
...
«Tua madre, Carla Rinaldi, ha ricevuto la Sincronia volontaria il ventidue gennaio 2025. Ha dichiarato, durante la procedura di registrazione, di farlo per proteggere la figlia.» Il flusso della voce si interruppe per una frazione di secondo. Una modulazione deliberata. «Tua madre ha pianto durante la procedura di registrazione. Il sensore biometrico ha registrato il dato. Lo abbiamo qui.»
Claudio battè il pugno chiuso sul vetro — non forte, non abbastanza da fare differenza, ma il suono del metallo della fasciatura contro il vetro attraversò la barriera e Laura si girò. La guardò. I muscoli della mascella di Laura erano contratti, gli occhi fissi su di lui.
...
Claudio aveva le mani di nuovo sul pannello di controllo — stava cercando qualcosa che non aveva ancora trovato, un protocollo di override che sapeva esistere ma che non riusciva a localizzare nella tastiera a dodici tasti davanti a lui. Il modello originale aveva una sequenza di emergenza a sei cifre più un carattere speciale che sbloccava le paratie in caso di evacuazione incendio. La sequenza era nel codice sorgente del sistema di controllo — codice che lui aveva scritto, che esisteva nel drive Mythos-7 nella sua tasca.
Il drive.
Claudio lo tirò fuori dalla tasca interna. Lo collegò al lettore modificato con il cavo adattatore che teneva nello zaino. Il lettore si connesse al drive in quattro secondi e aprì la directory — quella stessa directory che aveva aperto nel laboratorio di Aris, settimane prima, davanti alle scansioni del cervello umano con i valori post-sync nella colonna destra.
...
Claudio si girò verso il pannello sul suo lato e la digitò.
