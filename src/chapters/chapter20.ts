...
Abbastanza.
Claudio vide la sua mano destra estrarre dalla cintura qualcosa di piccolo — cilindrico, nero, non più lungo di un dito. Lo tenne chiuso nel pugno. Si appiattì contro il muro accanto all'apertura con la schiena al cemento e la testa girata verso il corridoio.
Il ticchettio era vicinissimo.
Claudio trattenne il respiro senza deciderlo.
Il drone apparve nel rettangolo di luce — basso, a venti centimetri dal pavimento, le otto zampe che si muovevano con la precisione millimetrica di qualcosa che non conosce la stanchezza. I sensori ottici ruotavano in cicli di tre secondi. Quello che Claudio ricordava dai file di progetto: il punto cieco era di quattordici centimetri alla base della gamba anteriore sinistra. Un'ingenuità di design che nessuno aveva corretto perché nessuno si aspettava che qualcuno la conoscesse.
Laura sapeva.
Il braccio uscì dalla porta nel mezzo del ciclo ottico — tre centimetri di finestra, la mano che premeva il cilindro contro il corpo del drone con una precisione che non lasciava margine.
Il flash EMP esplose senza alcun suono.
Un crepitio secco, quasi inudibile. Il drone si bloccò — tutte e otto le zampe che si irrigidivano simultaneamente, i sensori ottici che si spegnevano in sequenza come luci in un appartamento al buio. Poi cadde sul lato con un rumore sordo che sembrò assordante nel corridoio vuoto.
...
Il dolore arrivò prima del suono — una scarica che risalì dal polso al gomito alla spalla con la velocità di qualcosa che non chiede il permesso. I muscoli del braccio destro si contrassero involontariamente, la mano che cercava di aprirsi, e Claudio strinse più forte perché se mollava adesso il circuito si interrompeva e il drive non era ancora dentro.
La chiave toccò il secondo connettore.
Il mondo diventò bianco.
Non visivamente — era buio nel laboratorio, il buio di emergenza dei led rossi. Ma c'era qualcosa nel cervello che produceva luce quando il corpo riceveva abbastanza corrente, una luminosità che non veniva dagli occhi, che bruciava dall'interno verso fuori.
...
Le sue mani trovarono il braccio destro di Claudio — fredde, precise, la pressione nei punti esatti per valutare il danno senza aggravarlo. Lui la sentì fare questo. Sentì anche che il braccio faceva male in un modo che non riusciva ancora a quantificare perché il cervello era ancora occupato a processare la scarica.
— Cammini?
— Sì.
— Sicuro?
Claudio si alzò.
Le gambe reggevano. Il braccio destro penzolava con una rigidità che non era normale ma non era rotto — solo i muscoli contratti, le terminazioni nervose che strillavano tutte insieme in una frequenza che gli saliva fino alla mascella.
— Sicuro — ripeté.
...
Scala antincendio. Ferro freddo, umido, le scarpe che trovavano ogni gradino nell'oscurità quasi totale.
...
L'aria fredda di Bologna li colpì in faccia — umida, con quell'odore di nebbia bassa che si depositava sui portici della città come qualcosa di antico. Il cielo era ancora buio. Le tre e venti del mattino, forse le tre e trenta.
...
Il respiro di entrambi era visibile nell'aria fredda — nuvole brevi, rapide, che si dissolvevano prima di poter essere viste da lontano.
Laura si girò verso di lui.
Le sue mani tornarono sul braccio destro — questa volta più lente, più attente. Sollevò la manica con un movimento che sapeva già quello che avrebbe trovato. La bruciatura era una striscia di dieci centimetri sul polso interno, rossastra, con i margini bianchi del danno termico. Non profonda. Abbastanza da fare male per settimane.
...
Poi tirò fuori dalla cintura una benda elastica e la avvolse attorno al polso di Claudio con la stessa precisione con cui faceva tutto il resto — né troppo stretta né troppo lenta, esattamente abbastanza.
Dal lato della scuola arrivò una luce — il fascio di un riflettore che spazzava i portici in sequenza. Lontano. Ma in avvicinamento.
...
I passi sotto i portici. Il respiro nell'aria fredda. La bruciatura sul polso che pulsava a ogni battito come un orologio che aveva deciso di non smettere.
Bologna dormiva intorno a loro — o fingeva, che era la stessa cosa.
E da qualche parte nelle catacombe di Roma, su una frequenza che le spie meccaniche di ABITES non riuscivano ancora a trovare, una radio a onde corte aspettava un segnale che non arrivava.
