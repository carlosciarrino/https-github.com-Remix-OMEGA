...
6. 5.
4. 3.
«Dietro di me.» La voce di Laura era un ordine sferzante.
2. 1.
Le porte della cabina si aprirono con uno sblocco pneumatico che frustò l'aria. 
Il primo cane robot scattò, una massa di servomeccanismi lanciata in una traiettoria di annientamento.
Laura sparò. Tre lampi, tre squarci di luce bianca che bucarono il buio. L'impatto dei proiettili sulla giuntura della zampa della macchina fu secco, un rumore di osso metallico che si spezza. La macchina sbandò, il bilanciamento mancato — stridore di metallo che raschiava il cemento. Claudio afferrò Laura, il peso del suo corpo che gravava sulla spalla ferita, la spinse dentro la cabina, il dito che colpiva il tasto dell'ultimo piano.
La seconda unità caricò il varco — una massa di rabbia logica, di ingranaggi che portavano morte.
Le porte iniziarono a chiudersi — un lento sbarramento di acciaio che voleva separarli dal predatore. Un tonfo sordo, brutale, contro la cabina che iniziava a muoversi, fece tremare l'intera ascensione. Ascesero, portando il peso del mondo nel vuoto del palazzo.`;
