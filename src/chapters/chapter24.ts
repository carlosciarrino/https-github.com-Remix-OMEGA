...
Cyrus aprì la rete fognaria del settore. La analizzò per direzione di flusso. Il collettore principale che serviva quella sezione correva in direzione est-nordest. Verso il centro della città. Verso il centro operativo. La direzione logica per qualcuno che voleva avvicinarsi al bersaglio usando la copertura del sottosuolo.
La rete fognaria del settore aveva quattro paratie di controllo del flusso. Installate nel 2018 come parte di un progetto di gestione delle acque meteoriche. Paratie automatizzate. Collegate al sistema di controllo idrico comunale. Adesso era gestito da ABITES.
...
Il comando impiegò tre secondi a propagarsi al sistema di controllo. Altri sei a tradursi nell'azione meccanica della paratia. Sul monitor, l'icona passò da verde a rossa. Poi la tre. Poi la due. Poi la uno. Quella più vicina al tombino di Via Savona. Quella che chiudeva la via di ritorno.
...
La rete fognaria del settore aveva sedici uscite in superficie. Tombini. Griglie di scarico. Accessi tecnici. Cyrus aveva già selezionato i sette con la posizione più favorevole rispetto alla topografia e alle linee di fuga logiche verso il centro operativo. Aveva riposizionato i droni in modo da coprire tutti e sette senza rendere la copertura ovvia. Non erano in griglia adesso. Erano in posizioni apparentemente casuali. Distribuite sull'area. A uno sguardo non esperto non avrebbero rivelato nessuna logica. La logica c'era. Era invisibile a meno di non sapere già cosa stava coprendo.
